...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "please provide a real address");
        _owner = newOwner;
        emit transferredOwnership(_owner);
    }
...
contract Pausable is Ownable {
    ...
    function setPause(bool pause) public onlyOwner{
        require(_paused != pause, "the contract is already in the desired state");
        _paused = pause;
        if (_paused) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, "you already own the token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner,msg.sender), "you are not allowed to approve");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "you are not approved or the owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "it is not a valid address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function getTokenBaseURI() external returns(string memory){
...
contract CustomERC721Token is ERC721Metadata("Mountainhill Tokens", "MTT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
